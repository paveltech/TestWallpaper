...
import com.tasks.WallpaperHelper;
...
public class WallpaperDownloader {
    ...
    public static final String TAG = WallpaperDownloader.class.getSimpleName();
    ...
    public void start() {
        ...
        File directory = getDefaultWallpapersDirectory(mContext);
        File target = new File(directory, fileName);
        if (!directory.exists()) {
            if (!directory.mkdirs()) {
                Log.d(TAG , "Unable to create directory " +directory.toString());
